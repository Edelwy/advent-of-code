...
public class Advent112 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        char[][] mapaChar = new char[10][10]; //change if necessary//
        char[][] novaMapa = new char[10][10]; //change if necessary//
        int indeks = 0;
        boolean konec = true;
            ...
            for(int j = 0; j < mapaChar.length; j++) {
                for(int i = 0; i < mapaChar[0].length; i++) {
                    ...
                    if((j != 0) && (j != mapaChar.length - 1) && (i != 0) && (i != mapaChar[j].length - 1)) {
                        ...
                        if(mapaChar[j][i] == 'L') {
                            for(int k = 1; k < mapaChar.length; k++) {
                                if(mapaChar[j - k][i - k] == 'L') {
                                    vsotaPraznih++;
                                    break;
                                } 
                                if(mapaChar[j - k][i - k] == '.') continue;
                                if(mapaChar[j - k][i - k] == '#') break;
                            }
                            for(int k = 1; k < mapaChar.length; k++) {
                                if(mapaChar[j - k][i] == 'L') {
                                    vsotaPraznih++;
                                ...
                                if(mapaChar[j - k][i] == '.') continue;
                                if(mapaChar[j - k][i] == '#') break;
                            }
                            for(int k = 1; k < mapaChar.length; k++) {
                                if(mapaChar[j - k][i + k] == 'L') {
                                    vsotaPraznih++;
                            ...
                            for(int k = 1; k < mapaChar[0].length; k++) {
                                if(mapaChar[j][i - k] == 'L') {
                                    vsotaPraznih++;
                                    break;
                                } 
                                if(mapaChar[j][i - k] == '.') continue;
                                if(mapaChar[j][i - k] == '#') break;
                            }
                            for(int k = 1; k < mapaChar[0].length; k++) {
                                if(mapaChar[j][i + k] == 'L') {
                                    vsotaPraznih++;
                        ...
                        if((mapaChar[j][i] == '#') && (vsotaPolnih > 4)) novaMapa[j][i] = 'L';
                        if((mapaChar[j][i] == '#') && (vsotaPolnih <= 4)) novaMapa[j][i] = '#';
                    }
