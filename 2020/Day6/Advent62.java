...
public class Advent62 {
	public static void main(String[] args) {
		...
		while(sc.hasNextLine()) {
			...
			for(int da = 0; da < abeceda.length; da++) {
				if((allYes[da] == true) && (yes[da] == false))
				allYes[da] = false;
			}
			// System.out.println(Arrays.toString(allYes));
